...
def post():
    ...
    if form.accepts(request.vars, session):
        ...
        #http://127.0.0.1:8000/dantoblog/gestor/index/post/block.post/2/new/block?_signature=bd2f70367b6b03c1477a462e60efefbc1d74ec44

        session.flash = 'Señale ahora el bloque donde quiere presentar el post recién creado.'
        redirect(URL(r = request, c = 'gestor', f = 'index', args = ['post', 'block.post', form.vars.id, 'new']))
    elif form.errors:
        response.flash = 'err'
